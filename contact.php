...
<form method="post">
    ...
    <div class="form-group">Email:  <span class="error">* </span><input type="email" class="form-control" placeholder="Vul hier in" name="email" value="<?php echo (isset($_POST['email']) ? $_POST['email'] : '') ?>"></div>
